...
[![Go Report Card](https://goreportcard.com/badge/github.com/averyboy/protoreflect)](https://goreportcard.com/report/github.com/averyboy/protoreflect)
...
[![GoDoc](https://godoc.org/github.com/averyboy/protoreflect?status.svg)](https://godoc.org/github.com/averyboy/protoreflect)

----
## Descriptors: The Language Model of Protocol Buffers

```go
import "github.com/averyboy/protoreflect/desc"
```
...
*[Read more ≫](https://godoc.org/github.com/averyboy/protoreflect/desc)*

```go
import "github.com/averyboy/protoreflect/desc/protoparse"
```
...
*[Read more ≫](https://godoc.org/github.com/averyboy/protoreflect/desc/protoparse)*

```go
import "github.com/averyboy/protoreflect/desc/protoprint"
```
...
*[Read more ≫](https://godoc.org/github.com/averyboy/protoreflect/desc/protoprint)*

```go
import "github.com/averyboy/protoreflect/desc/builder"
```
...
*[Read more ≫](https://godoc.org/github.com/averyboy/protoreflect/desc/builder)*

----
## Dynamic Messages and Stubs

```go
import "github.com/averyboy/protoreflect/dynamic"
```
...
*[Read more ≫](https://godoc.org/github.com/averyboy/protoreflect/dynamic)*

```go
import "github.com/averyboy/protoreflect/dynamic/grpcdynamic"
```
...
*[Read more ≫](https://godoc.org/github.com/averyboy/protoreflect/dynamic/grpcdynamic)*

----
## gRPC Server Reflection

```go
import "github.com/averyboy/protoreflect/grpcreflect"
```
...
*[Read more ≫](https://godoc.org/github.com/averyboy/protoreflect/grpcreflect)*
